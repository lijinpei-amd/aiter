...
def test_op(
    ...
    # Build the reference per-expert: bulk upcast on > 2**31 elements (MiniMax-M3
    # at 128 experts) overflows int32 indexing and faults. Per-expert is
    # bit-identical to the bulk upcast.
    w_ref = torch.stack(
        [
